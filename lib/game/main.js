...
ig.global.FIELD_COLS = 20;
ig.global.FIELD_ROWS = 22; // the actual playing area is 10x18, but the top row is required for the line-shaped block 
ig.global.SHAPES = 8; // added 2
ig.global.SPAWN_POS_X = 820;
ig.global.SPAWN_POS_Y = 580;
ig.global.DROP_POS_X = 320;
ig.global.DROP_POS_Y = 64;
...
MyGame = ig.Game.extend({
    ...
    introMusic: new ig.Sound('media/sounds/themeMusic.mp3'),
...
MyLoader = ig.Loader.extend({
    ...
    draw: function() {
      ...
      //  ig.system.context.fillText( percentage, w/2.1,  h/1.4 );
    }
});
...
ig.main( '#canvas', MyGame, 60, 1024, 740, 1, MyLoader );
