...
.defines(function() {
    ...
    StageSelector = ig.Class.extend({
        ...
        bg: new ig.Image('media/stageScreenBig.png'),
        ...
        draw: function() {
          this.bg.draw(-270, 0);
            ...
            if (blink <= 1) {
                            ...
                            this.futura.draw("SELECT DIFFICULTY", ig.global.TILESIZE * 15.5, ig.global.TILESIZE * 14, ig.Font.ALIGN.CENTER);

           // this.font.draw("SELECT STAGE", ig.global.TILESIZE * 12, ig.global.TILESIZE * 12, ig.Font.ALIGN.CENTER);
            var xOffset = 0,
                yOffset = 0;
            ...
            for (var i = 0; i < this.stages.length; i++) {
                ...
                this.futura.draw(numberOut, (ig.global.TILESIZE*11.5) + xOffset, (ig.global.TILESIZE*14.5) + yOffset, ig.Font.ALIGN.CENTER);
